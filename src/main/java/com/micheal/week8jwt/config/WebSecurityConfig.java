                 ...
                 .authorizeHttpRequests(httpRequests->
                         httpRequests
                                 .requestMatchers("/api/v1/sign-up", "/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs/**", "/api/v1/google/**", "/v3/api-docs.yaml",
                                         "/api/v1/login","/api/save-post","/api/comment/create-comment/{postId}","/api/like/{postId}","/api/unlike/{postId}","/api/search-post/{title}","api/get-comment/{id}").permitAll()
                                 .requestMatchers("/api/v1/index","/api/like/{postId}","/api/unlike-comment/{id}",
                                         "/api/delete-comment/{id}","/api/comment/all-comment",
                                         "/api/find-comment-postId/{postId}","/api/edit-comment/{commentId}","/api/save-post","/api/all-post"
                                         ,"/api/delete-post/{id}","/api/edit-post/{id}").authenticated())
