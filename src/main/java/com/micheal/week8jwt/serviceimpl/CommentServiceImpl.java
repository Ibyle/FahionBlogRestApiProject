...
//    public ResponseEntity<List<Comment>> findCommentById(Long id){
//        List<Comment> findById = commentRepository.findAllCommentById
//        if (findById.isEmpty()){
//            return new ResponseEntity<>(findById, HttpStatus.NOT_FOUND);
//        }else{
